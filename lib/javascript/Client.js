...
function kb_orthofinder(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.annotate_plant_transcripts = function (input, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_orthofinder.annotate_plant_transcripts",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_orthofinder.status",
